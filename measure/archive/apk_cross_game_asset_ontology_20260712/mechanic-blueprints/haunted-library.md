# The Haunted Library Mechanic Blueprint

## Identity and fantasy

Open enchanted doors across a haunted library. Canonical ID: `game:haunted-library`; confidence: **high**.

## Learning loop

The player must find and open word doors in sentence order. Correct input advances one content step; incorrect or out-of-order input records feedback and an attempt without silently skipping required content.

## World and controls

multi-floor directional exploration with room transitions. The Phaser rebuild may choose native physics, cameras, pooling, and scene composition while preserving recognizable agency and target readability.

## Progression and terminal state

complete the ordered doors and exit or lose to haunts/time. Score, accuracy, correct answers, and attempts map to the established `GameResults`; authoritative XP and persistence remain host-owned.
