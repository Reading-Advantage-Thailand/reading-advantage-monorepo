# Dragon Flight Mechanic Blueprint

## Identity and fantasy

Grow a dragon flight through correct gates. Canonical ID: `game:dragon-flight`; confidence: **high**.

## Learning loop

The player must steer through the gate matching the vocabulary translation. Correct input advances one content step; incorrect or out-of-order input records feedback and an attempt without silently skipping required content.

## World and controls

horizontal steering in a forward-scrolling sky. The Phaser rebuild may choose native physics, cameras, pooling, and scene composition while preserving recognizable agency and target readability.

## Progression and terminal state

complete seeded rounds; wrong gates reduce growth or health. Score, accuracy, correct answers, and attempts map to the established `GameResults`; authoritative XP and persistence remain host-owned.
