...
- **Where**:
  ...
  - `measure/archive/apk_existing_core_cutover_20260727/plan.md` line 5 (Task 3 narrative) and `metadata.json::deviation_notes` both claim "seven fail-closed invariant groups".
