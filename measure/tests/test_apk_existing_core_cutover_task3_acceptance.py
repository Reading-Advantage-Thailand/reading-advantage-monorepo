...
TASK3_ACCEPTANCE_REVISION = "e0a5fb2a5"
...
class ExistingCoreTask3AcceptanceTests(unittest.TestCase):
    ...
    def test_catalog_and_loader_quarantine_bytes_remain_recoverable(self) -> None:
        """Pins historical quarantine at acceptance without blocking an additive successor."""
        self.assertEqual(
            _git_blob_sha256(TASK3_ACCEPTANCE_REVISION, "packages/game-cartridges/src/catalog.ts"),
            "14afe602f10710db17edc3a311177f16f148cac24473d3d975de4284ca19b55b",
        )
        self.assertEqual(
            _git_blob_sha256(TASK3_ACCEPTANCE_REVISION, "packages/game-cartridges/src/index.ts"),
            "1f9fdca42f51e5140dc998752ab2c6f6049ef07e1b78b3a90693e5e4fdbf8eda",
        )
        successor = _load_object(REPO_ROOT / "measure/apk-cross-host-cutover-candidate-v1.json")
    ...
    def test_plan_and_metadata_preserve_task3_acceptance_after_task4_progression(self) -> None:
        ...
        # The later additive Task-5 acceptance is complete. Task 6 may remain in
        # progress or be complete only when its own retirement guards pass.
        task5_line = next(
