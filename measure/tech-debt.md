...
| 2026-05-14 | codecamp_curriculum | `checkModulePrerequisite` uses fragile order-based logic | Medium | Open | Finds previous module via `order - 1`. Breaks if module order gaps exist or modules are reordered. |
