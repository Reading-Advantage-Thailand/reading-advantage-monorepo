...
| 2026-05-01 | migrate-reading-advantage | reading-advantage `ignoreBuildErrors: true` / `ignoreDuringBuilds: true` | Medium | Open | Temporarily enabled to pass build. |
| 2026-05-01 | migrate-reading-advantage | reading-advantage: 128 lint warnings, 26 failed test suites (37 tests) | Medium | Open | Pre-existing from original repo. |
...
| 2026-05-03 | science_auth | science-advantage manual auth verification pending | Medium | Open | Login, session, logout, impersonate flows need manual browser verification after shared auth migration. Google OAuth removed per auth strategy review. |
...
| 2026-05-03 | auth_strategy_review | science-advantage: 4 pre-existing analytics lint errors (cannot access variable) | Low | Open | class-analytics-overview.tsx, lesson-detail-analytics.tsx, student-detail-analytics.tsx, student-lesson-detail-analytics.tsx. Unrelated to auth. |
