...
| 2026-05-16 | codecamp_exercise_repos_20260515 | Phase 3 exercise repos (M11–15, 17) not created on GitHub | Medium | Open | Phase 2 (M2–10) repos created and pushed. Phase 3 (M11–15, 17) remaining: 6 exercise repos + capstone. Blocked by org credentials and manual/CI action outside monorepo. |
