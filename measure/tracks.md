...
- [x] **Track: APK Action and Defense Evidence Cohort — Batch A** *Link: [./tracks/apk_corpus_audit_action_defense_20260712/](./tracks/apk_corpus_audit_action_defense_20260712/)*
  Recover exact independently reviewed evidence packages for eight action, defense, escort, projectile, and arena games. **Batch A status: ACCEPTED-WITH-DISCLOSURE (conditional)** at HEAD `62ff2a4d`. Cycle 1 STOP-LOSS resolved in cycle 2: MD collector v2 `17859c16`/bind `760100fd` (Mode A additive supersession, 2 historical envelopes corrected from real-blob hash `a05dc35f…556d`), WVZ collector v2 `81c641a6`/bind `fadc4f46` (Mode B clean rewrite, 10 claims re-derived, plus supersede receipt documenting `ca423fbb` receipt mutation), truth-tests v2 `c8e6e78e`/bind `ea87fca2` (**47/47 PASS, 0 FAIL**), mapper v2 `2b23abe3`/bind `68769401` (187 claims, 178 resolved), adversarial review v2 `fd4c289f`/bind `e2609256` (17 claim re-derivations + 12 fixture re-derivations, 5 new semantic-range issues surfaced). Accepted-cohort-manifest `b096d911…2a54c`, candidate `8bd3c806…d5ac8`, product-owner acceptance `2582c940…36df1` (delegated authority). **Gates: G-DN GREEN, G-NF GREEN, G-BP GREEN, G-SL GREEN, G-AS GREEN, G-RR GREEN; G-CL YELLOW** (DISC-001: 5 valid-hash citations with claim_text overstatement: MD-MECH-002/006, MD-ASSET-016, MD-RESP-002, WVZ-ROUTE-007 — flagged for cycle-3 claim-text refinement; carried forward). Batches B–D (Village Guardian, Storm the Castle Tower, Paladin's Twin-Soul, Archer's Revenge, Gryphon Patrol, plus 3 more) NOT YET STARTED. See `_orchestrator/LAST-BATCH-STATUS.md`.*
