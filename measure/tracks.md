...
- [~] **Track: APK Action and Defense Evidence Cohort** *Link: [./tracks/apk_corpus_audit_action_defense_20260712/](./tracks/apk_corpus_audit_action_defense_20260712/)*
  Recover exact independently reviewed evidence packages for eight action, defense, escort, projectile, and arena games. *Status: BATCH-A STOP-LOSS CYCLE 1 (truth-tests authored; 38 PASS / 3 RED). Strategy committed `64293960`, mapper outputs `fc643d04`/bind `0b641aa3` (282 unique claim IDs cited), truth-tests `31dac90b`/bind `5464dc6b` (41 tests, 6 classes). **Gates RED: G-CL / G-SL / G-RR.** SLO-TTA-BA-1: 12 fabricated/anchor-drifted claims detected (MD-HIST-001/002 fabricated envelopes; WVZ-COMP-004/005/006, WVZ-MECH-008/019, WVZ-TEST-007/008, WVZ-HIST-002/003/004 — sequential-hex placeholder hashes, range-hash-equals-blob-hash, anchor drift). 10 of the 12 bad IDs are cited as blueprint backing → blueprint is evidentially contaminated in those entries. SLO-TTA-BA-2 (anti-pattern A15): WVZ collector receipt mutated in place by unrelated commit `ca423fbb` (Company SSO cutover postflight) — receipt's commit_sha and final_response_sha256 fields rewritten after binding, enumerated output hash matches neither HEAD nor `20af6417`. SLO-TTA-BA-3/BA-4: IMP-CD-1 and IMP-MD-1 receipt imperfections reconfirmed and confined. Per program rule "one unsupported or fabricated factual claim stops the batch," acceptance blocked. Remediation (cycle 1 of 2): dispatch MD re-collector (v2 ledger for the 2 historical claims) + WVZ re-collector (v2 ledger for the 10 claims + superseding receipt documenting ca423fbb mutation); then re-dispatch mapper with v2 inputs; then re-run truth-tests. Phase base SHA `9228c5c5`. See `_orchestrator/LAST-BATCH-STATUS.md`.*
