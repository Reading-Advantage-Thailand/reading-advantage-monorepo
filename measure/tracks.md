...
- [x] **Track: Protocol v1.1 + graph.db Rebuild (pre-audit chore)** *Link: [./tracks/protocol_v1_1_graphdb_20260603/](./tracks/protocol_v1_1_graphdb_20260603/)*
...
- [ ] **Track: App → Domain Layer Migration** (umbrella) *Link: [./tracks/app_domain_migration_20260603/](./tracks/app_domain_migration_20260603/)*
...
- [ ] **Track: TenantDB & schoolId Adoption** *Link: [./tracks/tenant_db_school_id_20260603/](./tracks/tenant_db_school_id_20260603/)*
  Phase 1 architectural decision: (a) add `schoolId` to 19 science tables + migrate to `createTenantDB` (AGENTS.md compliant; big schema change), or (b) document science-advantage's user-centric model as an intentional deviation. Resolves F-501, F-502. 2–4 weeks. Depends on Track 1. **Critical.** **Track 2.**

- [ ] **Track: Argon2id Migration + Auth Adapter Flatten** *Link: [./tracks/argon2id_password_20260603/](./tracks/argon2id_password_20260603/)*
