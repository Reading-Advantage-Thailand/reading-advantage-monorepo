...
- [~] **Track: APK Puzzle and Crafting Evidence Cohort** *Link: [./tracks/apk_corpus_audit_puzzle_crafting_20260712/](./tracks/apk_corpus_audit_puzzle_crafting_20260712/)*
  ...
  - [~] **Track: APK Special and Historical Evidence Cohort** *Link: [./tracks/apk_corpus_audit_special_historical_20260712/](./tracks/apk_corpus_audit_special_historical_20260712/)*
   Recover exact current and historical evidence for five distinctive, changed, cancelled, or missing games. **Batch A is conditionally accepted** at `c1e90338`; accepted-manifest SHA-256 `ef8aeb19…440d18`. **Batch B candidate published, non-consumable, awaiting explicit project-owner acceptance:** The Haunted Library and Babel Architect have 34 source-enveloped claims, 7 explicit unknowns, 12 negative fixtures, 13 mappings, two preserved no-game-surface browser records, 19/19 focused truth tests, distinct local specialist receipts with measured resource accounting, and a zero-blocker isolated adversarial review. No accepted manifest exists; no gameplay or responsive success is claimed.
