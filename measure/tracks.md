...
- [~] **Track: APK Action and Defense Evidence Cohort** *Link: [./tracks/apk_corpus_audit_action_defense_20260712/](./tracks/apk_corpus_audit_action_defense_20260712/)*
   Recover exact independently reviewed evidence packages for eight action, defense, escort, projectile, and arena games. **Batch A: ACCEPTED-WITH-DISCLOSURE (conditional)** at `62ff2a4d`; its accepted manifest is `b096d911…2a54c` and DISC-001 remains a process-only carry-forward disclosure. **Batch B: STOP-LOSS ACTIVE**: V16 truth contracts (49/49) and V11 fresh review clear prior evidence findings under the owner-directed WebBridge and local-provenance disclosures, but **T4B17-CRIT-001** blocks lifecycle consumption: the historical acceptance lacks required conversation/thread provenance and its nominal approval event predates candidate publication. Historical candidate/acceptance/accepted-manifest artifacts are non-consumable pending authenticated, ordered human product-owner approval, additive supersession, current gates, and fresh review. Batch C and cohort reconciliation have not started. See `_orchestrator/LAST-BATCH-STATUS.md`.*
...
- [~] **Track: APK Special and Historical Evidence Cohort** *Link: [./tracks/apk_corpus_audit_special_historical_20260712/](./tracks/apk_corpus_audit_special_historical_20260712/)*
  Recover exact current and historical evidence for five distinctive, changed, cancelled, or missing games. **Batch A is conditionally accepted** at `c1e90338`; accepted-manifest SHA-256 `ef8aeb19…440d18`. **Batch B Green evidence stage is prepared, not accepted:** The Haunted Library and Babel Architect have 34 source-enveloped claims, 7 explicit unknowns, 12 negative fixtures, 13 mappings, two bounded non-runnable/blocked browser records, and 19/19 focused truth tests. No official candidate, product-owner acceptance, or accepted manifest is published. Candidate authorization is blocked by T7-BB-BLOCK-001..003 (distinct-role receipts/resource accounting, independent browser disposition review, and fresh full-batch adversarial review).
