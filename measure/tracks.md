...
- [~] **Track: APK Action and Defense Evidence Cohort** *Link: [./tracks/apk_corpus_audit_action_defense_20260712/](./tracks/apk_corpus_audit_action_defense_20260712/)*
  Recover exact independently reviewed evidence packages for eight action, defense, escort, projectile, and arena games. *Status: BATCH-A EVIDENCE COLLECTED (326 atomic claims, 12 negative fixtures, 6 commits); evidence-collector outputs for Castle Defense (139 claims), Magic Defense (110 claims), Wizard vs Zombie (77 claims) committed; 2 stop-loss observations (SLO-MD-1 magic-defense-controller denominator gap, SLO-WVZ-1 www asset denominator gap) resolved as conditional-item + exclusion via `stop-loss-resolutions-batch-a.md` (T2 denominator hash unchanged). Next session: dispatch batch-A requirements-mapper, truth-test-author, browser-auditor, asset-auditor, adversarial-reviewer, then product-owner-acceptance.*
