...
- [ ] Task: Add the `Origin` check to the three state-changing finance routes. Source: `docs/accounting-ux-refactor-plan.md` §3; Issues: `app/api/auth/logout/route.ts:39`, `app/api/submissions/route.ts:241`, `app/api/submissions/[id]/approve/route.ts:105`, `app/api/submissions/[id]/reject/route.ts:106`
