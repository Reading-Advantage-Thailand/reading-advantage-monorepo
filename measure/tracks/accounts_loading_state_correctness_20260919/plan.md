...
- [ ] Task: Add `loading`, `ready`, and `failed` status to the console directory. Source: `docs/accounts-ux-refactor-plan.md` §4.3; Issues: `app/accounts-console.tsx:42,182-209`
- [ ] Task: Load the first employee list on the server in `app/page.tsx` and pass it as a prop. Source: `docs/accounts-ux-refactor-plan.md` §4.3; Issues: `app/accounts-console.tsx:47-56`, `app/page.tsx:14`
- [ ] Task: Add `app/error.tsx` and `app/not-found.tsx`. Source: `docs/accounts-ux-refactor-plan.md` §9; Issues: `app/page.tsx:14`, `app/error.tsx`, `app/not-found.tsx`
