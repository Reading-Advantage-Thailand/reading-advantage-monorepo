...
|---|---|---|---|---|---:|
| Accounts | `a2ccbd4d-5059-4e37-8452-0ec124bc284d` | `sha256:e9e3e12a7bd74225c6d9e6d430d633a0f2f148f621ddd1a66ced0db975ed96b1` | `accounts-00004-b9g` | `https://accounts.reading-advantage.com` | 100% |
...
- Accounts final Cloud Build completed successfully after migration, database
  doctor, runtime privilege, capability-audit, and service deployment gates.
...
- Accounts' production token-exchange path was also exercised directly against
  ...
  PostgreSQL `bigint` auth versions.
...
- Accounts: `/api/health`, `/api/ready`, discovery, and the discovery-advertised
  ...
  remained empty because the session cookie is HttpOnly; protected
  `/api/admin/employees` returned 200 with one employee.
...
- Accounts service: 14/14 tests, typecheck, and production build passed.
- Company-identity backend: 178 tests passed and 7 explicitly skipped; production
...
|---|---|---|
| Accounts | `accounts-00003-9kh` | `sha256:00e43fd7cefa05fb01dd1c6a03a39e706d03ca0845ccaff3e03f317268dccf92` |
...
- Codecamp migration and SSO cutover were not part of this release and remain
  open in Phase S6/S7.
- Negative company-admin-without-app-role denial testing remains open.
