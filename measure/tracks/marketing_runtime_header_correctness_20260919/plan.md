...
- [ ] Task: Add the `headers()` block, or set headers per route, and verify one built response. Source: `docs/marketing-ux-refactor-plan.md` §2; Issues: `apps/sales-advantage/next.config.ts:39-58`, `app/api/auth/session/route.ts:19`, `app/api/ready/route.ts:130`
- [ ] Task: Set `Cache-Control: no-store, private` on the eight authenticated route handlers. Source: `docs/marketing-ux-refactor-plan.md` §2; Issues: `app/api/campaigns/route.ts:43`, `app/api/campaigns/[id]/route.ts:50`, `app/api/settings/route.ts:19`, `app/api/settings/test-connection/route.ts:16`, `app/api/video/projects/route.ts:20`, `app/api/video/research-topics/route.ts:31`, `app/api/video/save-topics/route.ts:23`, `app/api/video/generate-script/route.ts:28`
- [ ] Task: Change the `vite.config.ts` alias to use `path.resolve`. Source: `docs/marketing-ux-refactor-plan.md` §2; Issues: `vite.config.ts:8`, `vitest.config.ts:12`
