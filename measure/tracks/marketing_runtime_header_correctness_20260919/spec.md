# Specification: Marketing Runtime Header Correctness

Track ID: `marketing_runtime_header_correctness_20260919`. Type: bug. App: `apps/marketing`.

## Overview

`docs/marketing-ux-refactor-plan.md` is the specification of record for this track.
This track covers Phase 1 (Runtime and header correctness) from that document.
