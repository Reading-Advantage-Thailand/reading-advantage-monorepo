# Specification: Sales Advantage Session Contract Correctness

Track ID: `sales_session_contract_correctness_20260919`. Type: bug. App: `apps/sales-advantage`.

## Overview

`docs/sales-advantage-ux-refactor-plan.md` is the specification of record for this track.
This track covers Phase 1 (Session contract correctness) from that document.
