...
- [ ] Task: Split `authenticateSalesRequest` into "no session" and "no Sales role". Source: `docs/sales-advantage-ux-refactor-plan.md` §2; Issues: `lib/company-oidc.ts:184-193`
- [ ] Task: Render `login.errorForbidden` when `isForbidden` is true. Source: `docs/sales-advantage-ux-refactor-plan.md` §2; Issues: `app/[locale]/page.tsx:53-57`, `messages/en.json:21`
