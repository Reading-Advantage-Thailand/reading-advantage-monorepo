...
4. Contact surfaces use one support email.
...
| Command | Result |
|---|---|
| `CI=true ../../node_modules/.bin/vitest run src/__tests__/phase-4-accessibility-navigation-contact.red.test.tsx --maxWorkers=1` | Expected Red: 4 tests fail with 18 missing-contract assertions. |
...
- Centralize contact details and route the contact form to the shared support email.
...
focused_result: 4 Phase 4 tests fail with 18 expected missing-contract assertions
