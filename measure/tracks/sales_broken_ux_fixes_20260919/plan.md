...
- [x] Task: Show the header navigation at every width (719e854). Source: `docs/sales-advantage-ux-refactor-plan.md` §7; Issues: `components/header.tsx:23`
...
- [x] Task: Delete the `ExternalLink` icon on the create-rep link, or open that link in a new tab. Source: `docs/sales-advantage-ux-refactor-plan.md` §5; Issues: `app/[locale]/admin/create-rep/page.tsx:51-54`
