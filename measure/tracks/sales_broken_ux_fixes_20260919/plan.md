...
- [x] Task: Return 200 with `session: null` for an anonymous request in `app/api/auth/session/route.ts`. Source: `docs/sales-advantage-ux-refactor-plan.md` §2; Issues: `app/api/auth/session/route.ts:8-15`
