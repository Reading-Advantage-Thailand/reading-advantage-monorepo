...
- [x] Task: Use `t("uploading")` during the roleplay upload state. Source: `docs/sales-advantage-ux-refactor-plan.md` §6; Issues: `components/roleplay-recorder.tsx:198`, `messages/en.json:226-227`
