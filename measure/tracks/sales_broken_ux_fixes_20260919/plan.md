...
- [x] Task: Delete the `refetch()` call in `app/[locale]/lesson/[id]/page.tsx:43`. Source: `docs/sales-advantage-ux-refactor-plan.md` §4; Issues: `app/[locale]/lesson/[id]/page.tsx:36-45`
