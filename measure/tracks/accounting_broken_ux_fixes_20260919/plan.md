...
- [ ] Task: Move `getAccountingCallbackOrigin()` inside the `try` block in the company start route. Source: `docs/accounting-ux-refactor-plan.md` §4.1; Issues: `app/api/auth/company/start/route.ts:41`
