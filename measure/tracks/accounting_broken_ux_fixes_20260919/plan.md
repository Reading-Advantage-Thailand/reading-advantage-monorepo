...
- [x] Task: Accept an HTTP loopback origin in `configuredOrigin` outside production. Source: `docs/accounting-ux-refactor-plan.md` §4.1; Issues: `app/lib/public-url.ts:28-45,87-94`, `packages/auth/src/company-identity/environment.ts:145-160`
