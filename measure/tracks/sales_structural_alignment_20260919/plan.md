...
- [x] (2f2330086) Task: Replace `lib/__tests__/i18n-key-parity.test.ts` with a full key-set comparison. Source: `docs/sales-advantage-ux-refactor-plan.md` §6; Issues: `lib/__tests__/i18n-key-parity.test.ts:7-10`
