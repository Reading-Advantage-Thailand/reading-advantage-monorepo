# Specification: Sales Advantage Recording Loading Correctness

Track ID: `sales_recording_loading_correctness_20260919`. Type: bug. App: `apps/sales-advantage`.

## Overview

`docs/sales-advantage-ux-refactor-plan.md` is the specification of record for this track.
This track covers Phase 2 (Recording and loading correctness) from that document.
