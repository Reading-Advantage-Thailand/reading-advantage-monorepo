...
- Prettier: exit 1; all five dossier files need formatting.
...
limitations: immutable Red pointer drift blocks three title dossiers; Prettier reports five dossier files
