...
- [ ] Task: Change the four topic handlers to the functional state form. Source: `docs/marketing-ux-refactor-plan.md` §3.2; Issues: `app/campaigns/[id]/video/page.tsx:233-251,334-338`
- [ ] Task: Make the topic editor a controlled input with a Save button. Source: `docs/marketing-ux-refactor-plan.md` §3.2; Issues: `app/campaigns/[id]/video/page.tsx:576-586`
