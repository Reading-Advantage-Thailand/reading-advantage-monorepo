...
| 3 | `pnpm turbo run build --filter=@reading-advantage/db && pnpm --filter @reading-advantage/webhooks vitest run src/__tests__/phase-6-acceptance.test.ts` | `CI=true pnpm --filter @reading-advantage/webhooks test` (78/78) | live behavior |
