...
| 3 | `cd packages/webhooks && npx vitest run src/__tests__/phase-7-closeout.test.ts` | same — bounded to the single closeout file | **artifact/doc contract** (not live behavior) |
