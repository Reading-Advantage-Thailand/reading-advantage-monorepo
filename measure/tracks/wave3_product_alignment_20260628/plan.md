...
- [x] Task: Author Phase 5 strategy and freeze embeddable-runtime/i18n/shared-package decisions. — `phase-5-decisions.md` + `test-strategy.md` §0.E (this Phase 5 strategy authoring commit)
