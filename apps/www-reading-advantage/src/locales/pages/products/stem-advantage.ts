...
export const th = {
    ...
    gradeBreakdown: {
        heading: "การแบ่งตามระดับชั้น",
        grades: [
            {
                grade: "ระดับชั้น 3-5",
                description: "แนะนำการเขียนโปรแกรมผ่านบล็อกภาพและแนวคิดพื้นฐาน",
            },
            {
                grade: "ระดับชั้น 6-8",
                description: "เปลี่ยนไปสู่การเขียนโปรแกรมแบบข้อความด้วยการใช้งานจริง",
            },
            {
                grade: "ระดับชั้น 9-12",
                description: "แนวคิดการเขียนโปรแกรมขั้นสูงและทักษะการพัฒนาเว็บ",
            },
        ],
    },
    benefits: {
        heading: "ประโยชน์สำหรับทุกคน",
        groups: [
            {
                title: "สำหรับนักเรียน",
                points: [
                    "เส้นทางการเรียนรู้ที่มีโครงสร้าง",
                    "ประสบการณ์การเขียนโค้ดแบบลงมือปฏิบัติ",
...
export const zh = {
    ...
    gradeBreakdown: {
        ...
        grades: [
            {
                grade: "3-5 年级",
                description: "通过可视化模块和基础概念介绍编程",
            },
            {
                grade: "6-8 年级",
                description: "向文本编程过渡并应用于实际",
            },
            {
                grade: "9-12 年级",
                description: "高级编程概念和网页开发技能",
            },
        ],
    },
    benefits: {
