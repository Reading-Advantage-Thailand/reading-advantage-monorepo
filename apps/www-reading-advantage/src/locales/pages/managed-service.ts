export const en = {
  ...
  overview: {
    ...
    description:
      "We take complete responsibility for your English program. From curriculum planning to teaching delivery to progress tracking - Reading Advantage handles everything.",
  ...
  features: {
    ...
    description:
      "Complete English department management with certified Reading Advantage teachers",
    items: [
...
export const th = {
  ...
  overview: {
    ...
    description:
      "เรารับผิดชอบในทุกอย่างของโปรแกรมภาษาอังกฤษของคุณ ตั้งแต่การวางแผนจนถึงการส่งมอบผลและการติดตามความก้าวหน้า เราจัดการทุกอย่างให้",
  ...
  features: {
    ...
    description:
      "การจัดการแผนกภาษาอังกฤษครบวงจรด้วยครู Reading Advantage ที่ได้รับการรับรอง",
    items: [
...
export const zh = {
  ...
  overview: {
    ...
    heading: "技术+教师",
    description:
      "我们对您的英语项目承担完全责任。从课程规划到教学交付再到进度跟踪 - 阅读优势处理一切。",
    strong: "您唯一需要管理的是：",
