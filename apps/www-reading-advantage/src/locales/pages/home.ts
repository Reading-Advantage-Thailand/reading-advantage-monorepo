export const en = {
    ...
    innovation: {
        ...
        features: {
            0: {
                title: "Extensive Reading Made Easy",
                description:
                    "AI curates leveled articles and topics that align with student interests, making twice-weekly extensive reading simple to run.",
            },
            1: {
...
export const th = {
    ...
    innovation: {
        ...
        features: {
            0: {
                title: "ทำให้การอ่านกว้างเป็นเรื่องง่าย",
                description:
                    "AI คัดสรรบทความตามระดับและหัวข้อที่ตรงกับความสนใจของนักเรียน ทำให้การอ่านกว้างสัปดาห์ละสองครั้งจัดได้ง่าย",
            },
            1: {
    ...
    qualityProtocol: {
        ...
        features: {
            0: {
                ...
                description: "การอ่านกว้างอย่างสม่ำเสมอโดยไม่มีการหยุดชะงักเพื่อการสัมผัสภาษาสูงสุด",
            },
            1: {
                title: "การมีส่วนร่วมของนักเรียน",
                description: "นักเรียนเลือกบทความที่ตรงกับความสนใจของพวกเขา ขับเคลื่อนแรงจูงใจภายใน",
            },
            2: {
                title: "ความเห็นพ้องต้องกันโดยข้อมูล",
    ...
    thaiSchools: {
        ...
        features: {
            0: {
                title: "การขาดแคลนครู",
                description: "แผนการสอนและคู่มือครูที่ครอบคลุมช่วยลดเวลาเตรียมการสอนอย่างมีนัยสำคัญ",
            },
            1: {
            ...
            2: {
                title: "อุปกรณ์จำกัด",
                description: "รูปแบบการเรียนรู้แบบผสมผสานทำงานได้กับอัตราส่วนอุปกรณ์ต่อนักเรียนใดๆ",
            },
        },
...
export const zh = {
    ...
    innovation: {
        ...
        features: {
            0: {
                title: "轻松开展泛读",
                description: "AI 根据学生兴趣精选不同难度的文章，让每周两次的泛读安排变得轻松",
            },
            1: {
                title: "轻松启动课堂",
                description:
    ...
    qualityProtocol: {
        ...
        features: {
            0: {
                title: "不间断阅读",
                description: "一致的泛读课程，无中断，最大化语言接触",
            },
            1: {
                title: "学生自主性",
                description: "学生选择符合兴趣的文章，激发内在动机",
            },
            2: {
                title: "数据驱动共识",
    ...
    thaiSchools: {
        ...
        features: {
            0: {
                title: "师资短缺",
                description: "全面的课程计划和教师指南显著减少备课时间",
            },
            1: {
                title: "大班教学",
            ...
            2: {
                title: "设备有限",
                description: "混合学习模式适用于任何设备与学生比例",
            },
        },
        poweredBy: "技术支持",
        technology: "Google Gemini & GPT-5 AI",
