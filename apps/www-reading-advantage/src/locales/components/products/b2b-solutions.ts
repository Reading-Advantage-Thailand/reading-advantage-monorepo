export const en = {
    title: "Transform Your Institution with Proven Solutions",
    ...
    products: {
        ...
        codecampAdvantage: {
            ...
            badge: "LIVE PLATFORM",
            gradeRange: "Full-stack development internship",
            features: {
                0: "Deliver a production curriculum across 4 phases, 20 modules, and 106 guided lessons",
                1: "Use the first complete, end-to-end Mastery Advantage implementation",
                2: "Connect versioned objectives to verified activity evidence and scaffold-aware confidence",
                3: "Give instructors an evidence ledger while keeping advisory AI review under human authority",
            },
        },
    },
};
export const th = {
    ...
    products: {
        ...
        codecampAdvantage: {
            title: "CodeCamp Advantage",
            badge: "แพลตฟอร์มพร้อมใช้งาน",
            gradeRange: "การฝึกงานพัฒนาฟูลสแตก",
            features: {
                0: "ใช้หลักสูตรจริง 4 เฟส 20 โมดูล และ 106 บทเรียนแบบมีแนวทาง",
                1: "ใช้ Mastery Advantage แบบครบวงจรเป็นแอป Advantage แรก",
                2: "เชื่อมวัตถุประสงค์มีเวอร์ชันกับหลักฐานกิจกรรมและความมั่นใจที่คำนึงถึงตัวช่วย",
                3: "ให้ผู้สอนใช้บัญชีหลักฐาน โดย AI รีวิวแบบให้คำแนะนำยังอยู่ภายใต้อำนาจมนุษย์",
            },
        },
    },
};
...
export const zh = {
    ...
    products: {
        ...
        codecampAdvantage: {
            ...
            gradeRange: "全栈开发实习课程",
            features: {
                0: "提供覆盖 4 个阶段、20 个模块和 106 节引导课程的生产课程",
                1: "使用首个端到端完整实施的 Mastery Advantage",
                2: "把版本化目标与可验证活动证据及支架感知信心连接起来",
                3: "为教师提供证据账本，同时让建议式 AI 审查服从人工权威",
            },
        },
    },
};
