...
export default {
  pages: {
    ...
    settingsUserProfile: {
      ...
      description: "Thông tin về hồ sơ cá nhân của bạn",
      backLink: "← Quay lại trang đọc",
      email: "Email",
      googleClassroom: "Liên kết Google Classroom",
      level: "Cấp độ Reading Advantage",
      xp: "XP Reading Advantage",
      xpDesc: "XP được dùng để lên cấp.",
    ...
    systemLicense: {
      heading: "Hệ thống",
      headerText: "Tạo giấy phép mới cho trường",
      cardTitle: "Tạo giấy phép mới cho trường của bạn",
      cardDescription:
        "Giấy phép là khóa để truy cập nền tảng. Bạn có thể tạo giấy phép mới cho trường. Hiện tại bạn có tổng cộng {count} giấy phép.",
      columns: {
        ...
        openMenu: "Mở menu",
        delete: "Xóa",
        copyLicenseKey: "Sao chép khóa giấy phép",
        viewDetails: "Xem chi tiết giấy phép",
        deleteTitle: "Xóa giấy phép?",
        deleteDescription:
          "Thao tác này sẽ xóa vĩnh viễn giấy phép của {schoolName}. Không thể hoàn tác.",
        deleting: "Đang xóa...",
        confirmDelete: "Xóa",
      },
      form: {
        schoolName: "Tên trường",
        schoolNamePlaceholder: "tên",
        schoolNameDescription: "Tên của trường",
        schoolNameMin: "Tên trường phải có ít nhất 5 ký tự.",
        schoolNameMax: "Tên trường chỉ được tối đa 60 ký tự.",
        adminId: "ID quản trị",
        adminIdPlaceholder: "ID",
        adminIdDescription:
          "ID của quản trị viên sẽ được chỉ định quản lý trường. Chịu trách nhiệm về vai trò quản trị.",
        total: "Tổng",
        totalPlaceholder: "tổng số giấy phép",
        totalDescription: "Tổng số giấy phép cần tạo.",
        subscriptionLevel: "Cấp độ đăng ký",
        subscriptionPlaceholder: "Chọn cấp độ đăng ký",
        subscriptionDescription: "Cấp độ đăng ký cho các giấy phép.",
        basic: "Cơ bản",
        premium: "Cao cấp",
        enterprise: "Doanh nghiệp",
        expirationDate: "Ngày hết hạn",
        expirationPlaceholder: "Chọn thờ​i hạn hiệu lực",
        expirationDescription: "Thờ​i hạn hiệu lực của giấy phép.",
        days180: "180 ngày",
        days360: "360 ngày",
        createLicenses: "Tạo giấy phép",
        createdTitle: "Đã tạo giấy phép.",
        createdDescription:
          "Đã tạo {total} giấy phép {level} cho {school}.",
        errorTitle: "Đã xảy ra lỗi.",
        errorDescription: "Tạo giấy phép thất bại",
      },
    },
    signInForm: {
      signIn: "Đăng nhập",
  ...
  components: {
    ...
    flashcards: {
      dashboard: {
        title: "Bảng điều khiển thẻ ghi nhớ",
        descriptionVocabulary: "Quản lý bộ thẻ từ vựng của bạn",
        descriptionSentence: "Quản lý bộ thẻ câu của bạn",
        descriptionAll: "Quản lý bộ thẻ từ vựng và câu của bạn",
        vocabularyTab: "Từ vựng",
        sentencesTab: "Câu",
      },
      emptyDeck: {
        readyPrompt: "Sẵn sàng bắt đầu hành trình học tập của bạn chưa?",
        badgeDefault: "HỆ THỐNG THẺ GHI NHỚ",
        stepLabel: "Bước {step}",
        howItWorksTitle: "Cách hoạt động",
        howItWorksDescription:
          "Bắt đầu với ba bước đơn giản và khởi đầu hành trình học tập của bạn",
        whyTitle: "Tại sao phương pháp này hiệu quả",
        whyDescription:
          "Xây dựng trên các nguyên tắc học tập khoa học để ghi nhớ tối đa",
        finalTitle: "Sẵn sàng bắt đầu học chưa?",
        finalDescription:
          "Tham gia cùng hàng nghìn ngườ​i học đang cải thiện kỹ năng ngôn ngữ mỗi ngày",
        feature1Title: "Lặp lại ngắt quãng",
        feature1Desc: "Phương pháp đã được chứng minh khoa học",
        feature2Title: "Cá nhân hóa",
        feature2Desc: "Nội dung phù hợp với bạn",
        feature3Title: "Theo dõi tiến độ",
        feature3Desc: "Giám sát sự cải thiện",
        feature4Title: "Đa ngôn ngữ",
        feature4Desc: "Học bất kỳ ngôn ngữ nào",
        startReadingNow: "Bắt đầu đọc ngay",
        browseArticles: "Duyệt bài viết",
        vocabulary: {
          title: "Bắt đầu hành trình từ vựng của bạn",
          description:
            "Tạo bộ thẻ ghi nhớ cá nhân bằng cách đọc bài viết và lưu từ vựng. Làm chủ từ mới với phương pháp lặp lại ngắt quãng đã được chứng minh khoa học.",
          actionText: "Bắt đầu đọc để học từ vựng",
          step1Text: "Đọc bài viết",
          step1Desc: "Khám phá nội dung theo trình độ đọc của bạn",
          step2Text: "Lưu từ vựng",
          step2Desc: "Nhấp vào từ để thêm vào bộ thẻ của bạn",
          step3Text: "Học và làm chủ",
          step3Desc: "Học với phương pháp lặp lại ngắt quãng",
        },
        sentence: {
          title: "Bắt đầu làm chủ câu của bạn",
          description:
            "Xây dựng khả năng hiểu câu bằng cách đọc bài viết và lưu những câu có ý nghĩa. Luyện tập kỹ năng hiểu và dịch thuật qua các thẻ ghi nhớ tương tác.",
          actionText: "Bắt đầu đọc để học câu",
          step1Text: "Đọc bài viết",
          step1Desc: "Khám phá nội dung hấp dẫn để học",
          step2Text: "Lưu câu",
          step2Desc: "Chọn những câu có ý nghĩa để luyện tập",
          step3Text: "Luyện dịch",
          step3Desc: "Làm chủ khả năng hiểu câu",
        },
        all: {
          title: "Bắt đầu cuộc phiêu lưu học tập của bạn",
          description:
            "Xây dựng bộ thẻ ghi nhớ cá nhân bằng cách đọc bài viết và lưu từ vựng hoặc câu. Sử dụng phương pháp lặp lại ngắt quãng đã được chứng minh khoa học để học hiệu quả và ghi nhớ nhiều hơn.",
          actionText: "Bắt đầu đọc bài viết",
          step1Text: "Đọc nội dung",
          step1Desc: "Chọn từ các bài viết được tuyển chọn theo trình độ của bạn",
          step2Text: "Xây dựng bộ thẻ của bạn",
          step2Desc: "Lưu những từ và câu quan trọng",
          step3Text: "Học và tiến bộ",
          step3Desc: "Làm chủ với phương pháp lặp lại ngắt quãng",
        },
      },
      deck: {
        needMoreCardsTitle: "Cần thêm thẻ để bắt đầu học",
        needMoreCardsDesc:
          "Thêm {count} thẻ nữa từ bài viết để mở khóa việc học.",
        allCaughtUpTitle: "🎉 Đã hoàn thành tất cả!",
        allCaughtUpDesc: "Tất cả các thẻ đều đã cập nhật. Quay lại sau để ôn tập thêm.",
        readyTitle: "Sẵn sàng học!",
        readyDesc: "{count} thẻ đã sẵn sàng để ôn tập.",
        learningProgress: "Tiến độ học tập",
        completeLabel: "Hoàn thành",
        masteredLabel: "Đã làm chủ {count}",
        toReviewLabel: "Cần ôn tập {count}",
        cardStatusTitle: "Chi tiết trạng thái thẻ",
        newLabel: "Mới",
        newDesc: "Thẻ mới cần học",
        learningLabel: "Đang học",
        learningDesc: "Đang tiến hành",
        reviewLabel: "Ôn tập",
        reviewDesc: "Đến lúc ôn tập",
        translationLanguage: "Ngôn ngữ dịch",
        languageChangedTitle: "Đã thay đổi ngôn ngữ",
        languageChangedDesc: "Ngôn ngữ dịch đã được đổi thành {language}",
        definitionsNote: "Định nghĩa sẽ được hiển thị bằng ngôn ngữ này",
        translationsNote: "Bản dịch sẽ được hiển thị bằng ngôn ngữ này",
        loadingCards: "Đang tải thẻ...",
        startStudying: "Bắt đầu học ({count} thẻ)",
        allCaughtUpButton: "Đã hoàn thành tất cả! 🎉",
        readArticlesToAddCards: "Đọc bài viết để thêm thẻ",
        refreshData: "Làm mới dữ liệu",
        refreshSuccessTitle: "Thành công",
        refreshSuccessDesc: "Đã làm mới dữ liệu!",
        addMoreCards: "Thêm thẻ",
        noCardsTitle: "Không có thẻ khả dụng",
        noCardsDesc: "Hiện không có thẻ nào cần ôn tập! ⏰",
        errorTitle: "Lỗi",
        loadCardsError: "Không tải được thẻ",
        defaultDeckName: "Bộ thẻ ghi nhớ",
      },
      game: {
        errorTitle: "Lỗi",
        noTranslation: "Không có bản dịch",
        sessionCompleteTitle: "Đã hoàn thành phiên học!",
        xpEarned: "+{xp} XP đã nhận!",
        greatJob: "Làm tốt lắm! Bạn đã hoàn thành phiên thẻ ghi nhớ.",
        correctLabel: "Đúng",
        incorrectLabel: "Sai",
        timeLabel: "Thờ​i gian",
        completeSession: "Hoàn thành phiên",
        backToDashboard: "Quay lại bảng điều khiển",
        noCardsTitle: "Không có thẻ khả dụng",
        noCardsDesc: "Hiện không có thẻ nào để học.",
        ...
        stateReview: "ÔN TẬP",
        noWord: "Không có từ",
        noSentence: "Không có câu",
        definitionLabel: "Định nghĩa",
        noDefinition: "Không có định nghĩa",
        exampleLabel: "Ví dụ",
        translationLabel: "Bản dịch",
        howWell: "Bạn biết nội dung này đến mức nào?",
        againLabel: "Học lại",
        hardLabel: "Khó",
        goodLabel: "Tốt",
        easyLabel: "Dễ",
        wordQuestion: "Từ này có nghĩa là gì?",
        sentenceQuestion: "Câu này có nghĩa là gì?",
        showAnswer: "Hiện đáp án",
        skipLabel: "Bỏ qua",
        accuracyLabel: "Độ chính xác: {percent}%",
        congratulationsTitle: "🎉 Chúc mừng!",
        xpEarnedToast: "Bạn đã nhận được {xp} XP!",
        successTitle: "Thành công",
        sessionCompletedDesc: "Đã hoàn thành phiên học!",
        sessionCompletedTitle: "Đã hoàn thành phiên!",
        totalXpDesc: "Tổng XP đã nhận: {xp}",
        saveProgressError: "Không lưu được tiến độ. Vui lòng thử lại.",
        submitRatingError: "Không lưu được tiến độ. Vui lòng thử lại.",
      },
    },
    userAccountNav: {
