...
export default {
  pages: {
    ...
    settingsUserProfile: {
      ...
      description: "ข้อมูลเกี่ยวกับโปรไฟล์ส่วนตัวของคุณ",
      backLink: "← กลับไปที่หน้าการอ่าน",
      email: "อีเมล",
      googleClassroom: "ลิงก์ Google Classroom",
      level: "ระดับ Reading Advantage",
      xp: "XP Reading Advantage",
      xpDesc: "XP ใช้สำหรับเลื่อนระดับ",
      unknown: "ไม่ทราบ",
      verified: "ยืนยันแล้ว",
    ...
    systemLicense: {
      heading: "ระบบ",
      headerText: "สร้างใบอนุญาตใหม่สำหรับโรงเรียน",
      cardTitle: "สร้างใบอนุญาตใหม่สำหรับโรงเรียนของคุณ",
      cardDescription:
        "ใบอนุญาตคือคีย์สำหรับเข้าถึงแพลตฟอร์ม คุณสามารถสร้างใบอนุญาตใหม่สำหรับโรงเรียนได้ ขณะนี้คุณมีใบอนุญาตทั้งหมด {count} ใบ",
      columns: {
        ...
        openMenu: "เปิดเมนู",
        delete: "ลบ",
        copyLicenseKey: "คัดลอกคีย์ใบอนุญาต",
        viewDetails: "ดูรายละเอียดใบอนุญาต",
        deleteTitle: "ลบใบอนุญาต?",
        deleteDescription:
          "การดำเนินการนี้จะลบใบอนุญาตของ {schoolName} อย่างถาวร ไม่สามารถยกเลิกได้",
        deleting: "กำลังลบ...",
        confirmDelete: "ลบ",
      },
      form: {
        schoolName: "ชื่อโรงเรียน",
        schoolNamePlaceholder: "ชื่อ",
        schoolNameDescription: "ชื่อของโรงเรียน",
        schoolNameMin: "ชื่อโรงเรียนต้องมีอย่างน้อย 5 ตัวอักษร",
        schoolNameMax: "ชื่อโรงเรียนต้องมีไม่เกิน 60 ตัวอักษร",
        adminId: "รหัสผู้ดูแล",
        adminIdPlaceholder: "รหัส",
        adminIdDescription:
          "รหัสของผู้ดูแลที่จะได้รับมอบหมายให้จัดการโรงเรียน รับผิดชอบบทบาทผู้ดูแล",
        total: "จำนวน",
        totalPlaceholder: "จำนวนใบอนุญาตทั้งหมด",
        totalDescription: "จำนวนใบอนุญาตทั้งหมดที่จะสร้าง",
        subscriptionLevel: "ระดับการสมัครสมาชิก",
        subscriptionPlaceholder: "เลือกระดับการสมัครสมาชิก",
        subscriptionDescription: "ระดับการสมัครสมาชิกสำหรับใบอนุญาต",
        basic: "พื้นฐาน",
        premium: "พรีเมียม",
        enterprise: "องค์กร",
        expirationDate: "วันหมดอายุ",
        expirationPlaceholder: "เลือกระยะเวลาหมดอายุ",
        expirationDescription: "ระยะเวลาหมดอายุสำหรับใบอนุญาต",
        days180: "180 วัน",
        days360: "360 วัน",
        createLicenses: "สร้างใบอนุญาต",
        createdTitle: "สร้างใบอนุญาตแล้ว",
        createdDescription:
          "สร้างใบอนุญาต {level} จำนวน {total} ใบสำหรับ {school} แล้ว",
        errorTitle: "เกิดข้อผิดพลาด",
        errorDescription: "สร้างใบอนุญาตไม่สำเร็จ",
      },
    },
    signInForm: {
      signIn: "เข้าสู่ระบบ",
  ...
  components: {
    ...
    flashcards: {
      dashboard: {
        title: "แดชบอร์ดบัตรคำ",
        descriptionVocabulary: "จัดการสำรับคำศัพท์สำหรับการเรียนรู้ของคุณ",
        descriptionSentence: "จัดการสำรับประโยคสำหรับการเรียนรู้ของคุณ",
        descriptionAll: "จัดการสำรับคำศัพท์และประโยคสำหรับการเรียนรู้ของคุณ",
        vocabularyTab: "คำศัพท์",
        sentencesTab: "ประโยค",
      },
      emptyDeck: {
        readyPrompt: "พร้อมเริ่มต้นการเดินทางการเรียนรู้ของคุณหรือยัง?",
        badgeDefault: "ระบบบัตรคำ",
        stepLabel: "ขั้นตอนที่ {step}",
        howItWorksTitle: "วิธีการทำงาน",
        howItWorksDescription:
          "เริ่มต้นในสามขั้นตอนง่าย ๆ และเริ่มการเดินทางการเรียนรู้ของคุณ",
        whyTitle: "ทำไมวิธีนี้ถึงได้ผล",
        whyDescription:
          "สร้างขึ้นบนหลักการเรียนรู้ทางวิทยาศาสตร์เพื่อการจำที่ดีที่สุด",
        finalTitle: "พร้อมเริ่มต้นการเรียนรู้หรือยัง?",
        finalDescription:
          "ร่วมกับผู้เรียนหลายพันคนที่พัฒนาทักษะภาษาของพวกเขาทุกวัน",
        feature1Title: "การทบทวนระยะห่าง",
        feature1Desc: "วิธีที่พิสูจน์แล้วทางวิทยาศาสตร์",
        feature2Title: "เฉพาะสำหรับคุณ",
        feature2Desc: "เนื้อหาที่ปรับตามตัวคุณ",
        feature3Title: "ติดตามความคืบหน้า",
        feature3Desc: "ติดตามการพัฒนา",
        feature4Title: "หลายภาษา",
        feature4Desc: "เรียนภาษาใดก็ได้",
        startReadingNow: "เริ่มอ่านเลย",
        browseArticles: "เรียกดูบทความ",
        vocabulary: {
          title: "เริ่มต้นการเดินทางคำศัพท์ของคุณ",
          description:
            "สร้างสำรับบัตรคำที่เฉพาะสำหรับคุณโดยการอ่านบทความและบันทึกคำศัพท์ เอาชนะคำใหม่ด้วยการทบทวนระยะห่างที่พิสูจน์แล้วทางวิทยาศาสตร์",
          actionText: "เริ่มอ่านเพื่อคำศัพท์",
          step1Text: "อ่านบทความ",
          step1Desc: "เรียกดูเนื้อหาตามระดับการอ่านของคุณ",
          step2Text: "บันทึกคำศัพท์",
          step2Desc: "คลิกที่คำเพื่อเพิ่มลงในสำรับของคุณ",
          step3Text: "เรียนรู้และเชี่ยวชาญ",
          step3Desc: "เรียนรู้ด้วยการทบทวนระยะห่าง",
        },
        sentence: {
          title: "เริ่มต้นการเชี่ยวชาญประโยคของคุณ",
          description:
            "สร้างความเข้าใจประโยคโดยการอ่านบทความและบันทึกประโยคที่มีความหมาย ฝึกฝนทักษะการเข้าใจและการแปลผ่านบัตรคำแบบโต้ตอบ",
          actionText: "เริ่มอ่านเพื่อประโยค",
          step1Text: "อ่านบทความ",
          step1Desc: "ค้นพบเนื้อหาที่น่าสนใจเพื่อเรียนรู้",
          step2Text: "บันทึกประโยค",
          step2Desc: "เลือกประโยคที่มีความหมายเพื่อฝึกฝน",
          step3Text: "ฝึกการแปล",
          step3Desc: "เชี่ยวชาญการเข้าใจประโยค",
        },
        all: {
          title: "เริ่มต้นการผจญภัยการเรียนรู้ของคุณ",
          description:
            "สร้างสำรับบัตรคำที่เฉพาะสำหรับคุณโดยการอ่านบทความและบันทึกคำศัพท์หรือประโยค ใช้การทบทวนระยะห่างที่พิสูจน์แล้วทางวิทยาศาสตร์เพื่อเรียนรู้อย่างมีประสิทธิภาพและจำได้มากขึ้น",
          actionText: "เริ่มอ่านบทความ",
          step1Text: "อ่านเนื้อหา",
          step1Desc: "เลือกจากบทความที่คัดสรรตามระดับของคุณ",
          step2Text: "สร้างสำรับของคุณ",
          step2Desc: "บันทึกคำศัพท์และประโยคที่สำคัญ",
          step3Text: "เรียนรู้และพัฒนา",
          step3Desc: "เชี่ยวชาญด้วยการทบทวนระยะห่าง",
        },
      },
      deck: {
        needMoreCardsTitle: "ต้องการการ์ดเพิ่มเพื่อเริ่มเรียน",
        needMoreCardsDesc:
          "เพิ่มการ์ดอีก {count} ใบจากบทความเพื่อปลดล็อกการเรียน",
        allCaughtUpTitle: "🎉 ทำครบแล้ว!",
        allCaughtUpDesc: "การ์ดทั้งหมดเป็นปัจจุบันแล้ว กลับมาใหม่เพื่อทบทวนเพิ่ม",
        readyTitle: "พร้อมเรียนแล้ว!",
        readyDesc: "มีการ์ด {count} ใบพร้อมสำหรับการทบทวน",
        learningProgress: "ความคืบหน้าการเรียนรู้",
        completeLabel: "สมบูรณ์",
        masteredLabel: "เชี่ยวชาญแล้ว {count}",
        toReviewLabel: "ต้องทบทวน {count}",
        cardStatusTitle: "สรุปสถานะการ์ด",
        newLabel: "ใหม่",
        newDesc: "การ์ดใหม่สำหรับการเรียนรู้",
        learningLabel: "กำลังเรียนรู้",
        learningDesc: "อยู่ในระหว่างดำเนินการ",
        reviewLabel: "ทบทวน",
        reviewDesc: "ถึงเวลาทบทวน",
        translationLanguage: "ภาษาแปล",
        languageChangedTitle: "เปลี่ยนภาษาแล้ว",
        languageChangedDesc: "เปลี่ยนภาษาแปลเป็น {language}",
        definitionsNote: "คำจำกัดความจะแสดงเป็นภาษานี้",
        translationsNote: "คำแปลจะแสดงเป็นภาษานี้",
        loadingCards: "กำลังโหลดการ์ด...",
        startStudying: "เริ่มเรียน ({count} ใบ)",
        allCaughtUpButton: "ทำครบแล้ว! 🎉",
        readArticlesToAddCards: "อ่านบทความเพื่อเพิ่มการ์ด",
        refreshData: "รีเฟรชข้อมูล",
        refreshSuccessTitle: "สำเร็จ",
        refreshSuccessDesc: "รีเฟรชข้อมูลแล้ว!",
        addMoreCards: "เพิ่มการ์ด",
        noCardsTitle: "ไม่มีการ์ดที่ใช้ได้",
        noCardsDesc: "ไม่มีการ์ดที่ต้องทบทวนในขณะนี้! ⏰",
        errorTitle: "ข้อผิดพลาด",
        loadCardsError: "โหลดการ์ดไม่สำเร็จ",
        defaultDeckName: "สำรับบัตรคำ",
      },
      game: {
        errorTitle: "ข้อผิดพลาด",
        noTranslation: "ไม่มีคำแปล",
        sessionCompleteTitle: "จบเซสชันการเรียนแล้ว!",
        xpEarned: "+{xp} XP ที่ได้รับ!",
        greatJob: "ทำได้ดีมาก! คุณทำเซสชันบัตรคำเสร็จสมบูรณ์",
        correctLabel: "ถูกต้อง",
        incorrectLabel: "ไม่ถูกต้อง",
        timeLabel: "เวลา",
        completeSession: "จบเซสชัน",
        backToDashboard: "กลับไปที่แดชบอร์ด",
        noCardsTitle: "ไม่มีการ์ดที่ใช้ได้",
        noCardsDesc: "ไม่มีการ์ดสำหรับเรียนในขณะนี้",
        cardProgress: "การ์ดใบที่ {current} จาก {total}",
        progressLabel: "ความคืบหน้า",
        stateNew: "ใหม่",
        stateLearning: "กำลังเรียนรู้",
        stateReview: "ทบทวน",
        noWord: "ไม่มีคำ",
        noSentence: "ไม่มีประโยค",
        definitionLabel: "คำจำกัดความ",
        noDefinition: "ไม่มีคำจำกัดความ",
        exampleLabel: "ตัวอย่าง",
        translationLabel: "คำแปล",
        howWell: "คุณรู้คำนี้ดีแค่ไหน?",
        againLabel: "อีกครั้ง",
        hardLabel: "ยาก",
        goodLabel: "ดี",
        easyLabel: "ง่าย",
        wordQuestion: "คำนี้หมายความว่าอะไร?",
        sentenceQuestion: "ประโยคนี้หมายความว่าอะไร?",
        showAnswer: "แสดงคำตอบ",
        skipLabel: "ข้าม",
        accuracyLabel: "ความแม่นยำ: {percent}%",
        congratulationsTitle: "🎉 ขอแสดงความยินดี!",
        xpEarnedToast: "คุณได้รับ {xp} XP!",
        successTitle: "สำเร็จ",
        sessionCompletedDesc: "จบเซสชันการเรียนแล้ว!",
        sessionCompletedTitle: "จบเซสชันแล้ว!",
        totalXpDesc: "XP รวมที่ได้รับ: {xp}",
        saveProgressError: "บันทึกความคืบหน้าไม่สำเร็จ โปรดลองอีกครั้ง",
        submitRatingError: "บันทึกความคืบหน้าไม่สำเร็จ โปรดลองอีกครั้ง",
      },
    },
    userAccountNav: {
      level: "ระดับ {level}",
