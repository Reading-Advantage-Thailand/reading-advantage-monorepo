...
export default {
  pages: {
    ...
    settingsUserProfile: {
      ...
      description: "Information about your personal profile",
      backLink: "← Back to Reading Page",
      email: "Email",
      googleClassroom: "Google Classroom Link",
      level: "Reading advantage level",
      xp: "Reading advantage XP",
      xpDesc: "The XP is used to level up.",
      unknown: "unknown",
      verified: "Verified",
    ...
    systemLicense: {
      heading: "System",
      headerText: "Create a new license for school",
      cardTitle: "Create a new license for your school",
      cardDescription:
        "License is a key to access the platform. You can create a new license for the school. Currently you have a total of {count} license(s).",
      columns: {
        ...
        deleteDescription:
          "This permanently deletes the license for {schoolName}. This action cannot be undone.",
        deleting: "Deleting...",
        confirmDelete: "Delete",
      },
      form: {
        schoolName: "School name",
        schoolNamePlaceholder: "name",
        schoolNameDescription: "The name of the school",
        schoolNameMin: "School name must be at least 5 characters.",
        schoolNameMax: "School name must be at most 60 characters.",
        adminId: "Admin ID",
        adminIdPlaceholder: "ID",
        adminIdDescription:
          "The id of the admin that will be assigned to manage the school. Responsible for admin roles.",
        total: "Total",
        totalPlaceholder: "total licenses",
        totalDescription: "The total number of licenses to create.",
        subscriptionLevel: "Subscription Level",
        subscriptionPlaceholder: "Select a subscription level",
        subscriptionDescription: "The subscription level for the licenses.",
        basic: "Basic",
        premium: "Premium",
        enterprise: "Enterprise",
        expirationDate: "Expiration Date",
        expirationPlaceholder: "Select an expiration period",
        expirationDescription: "The expiration period for the licenses.",
        days180: "180 days",
        days360: "360 days",
        createLicenses: "Create Licenses",
        createdTitle: "Created licenses.",
        createdDescription:
          "Created {total} {level} licenses for {school}.",
        errorTitle: "An error occurred.",
        errorDescription: "Failed to create licenses",
      },
    },
    signInForm: {
      signIn: "Sign in",
  ...
  components: {
    ...
    flashcards: {
      dashboard: {
        ...
        descriptionVocabulary: "Manage your vocabulary learning decks",
        descriptionSentence: "Manage your sentence learning decks",
        descriptionAll: "Manage your vocabulary and sentence learning decks",
        vocabularyTab: "Vocabulary",
        sentencesTab: "Sentences",
      },
      emptyDeck: {
        readyPrompt: "Ready to start your learning journey?",
        badgeDefault: "FLASHCARD SYSTEM",
        stepLabel: "Step {step}",
        ...
        feature1Title: "Spaced Repetition",
        feature1Desc: "Scientifically proven method",
        feature2Title: "Personalized",
        feature2Desc: "Content tailored to you",
        feature3Title: "Track Progress",
        feature3Desc: "Monitor improvement",
        feature4Title: "Multi-Language",
        feature4Desc: "Learn any language",
        ...
        vocabulary: {
          ...
          step1Text: "Read Articles",
          step1Desc: "Browse content at your reading level",
          step2Text: "Save Words",
          step2Desc: "Click words to add to your deck",
          step3Text: "Study & Master",
          step3Desc: "Learn with spaced repetition",
        },
        sentence: {
          ...
          step1Text: "Read Articles",
          step1Desc: "Discover engaging content to learn from",
          step2Text: "Save Sentences",
          step2Desc: "Select meaningful sentences for practice",
          step3Text: "Practice Translation",
          step3Desc: "Master sentence understanding",
        },
        all: {
          ...
          step1Text: "Read Content",
          step1Desc: "Choose from curated articles at your level",
          step2Text: "Build Your Deck",
          step2Desc: "Save words and sentences that matter",
          step3Text: "Study & Progress",
          step3Desc: "Master with spaced repetition",
        },
      },
      deck: {
        needMoreCardsTitle: "Need more cards to start studying",
        needMoreCardsDesc:
          "Add {count} more cards from articles to unlock studying.",
        allCaughtUpTitle: "🎉 All caught up!",
        allCaughtUpDesc: "All cards are up to date. Come back later for more reviews.",
        readyTitle: "Ready to study!",
        readyDesc: "{count} cards are ready for review.",
        learningProgress: "Learning Progress",
        completeLabel: "Complete",
        masteredLabel: "{count} mastered",
        toReviewLabel: "{count} to review",
        cardStatusTitle: "Card Status Breakdown",
        newLabel: "New",
        newDesc: "Fresh cards to learn",
        learningLabel: "Learning",
        learningDesc: "In progress",
        reviewLabel: "Review",
        reviewDesc: "Time for review",
        translationLanguage: "Translation Language",
        languageChangedTitle: "Language Changed",
        languageChangedDesc: "Translation language changed to {language}",
        definitionsNote: "Definitions will be shown in this language",
        translationsNote: "Translations will be shown in this language",
        loadingCards: "Loading Cards...",
        startStudying: "Start Studying ({count} cards)",
        allCaughtUpButton: "All Caught Up! 🎉",
        readArticlesToAddCards: "Read Articles to Add Cards",
        ...
        noCardsDesc: "No cards are due for review right now! ⏰",
        errorTitle: "Error",
        loadCardsError: "Failed to load cards",
        defaultDeckName: "Flashcard Deck",
      },
      game: {
        errorTitle: "Error",
        noTranslation: "No translation",
        sessionCompleteTitle: "Study Session Complete!",
        xpEarned: "+{xp} XP Earned!",
        greatJob: "Great job! You've completed your flashcard session.",
        ...
        noCardsTitle: "No Cards Available",
        noCardsDesc: "There are no cards to study at this time.",
        ...
        goodLabel: "Good",
        easyLabel: "Easy",
        wordQuestion: "What does this word mean?",
        sentenceQuestion: "What does this sentence mean?",
        showAnswer: "Show Answer",
        skipLabel: "Skip",
        accuracyLabel: "Accuracy: {percent}%",
        congratulationsTitle: "🎉 Congratulations!",
        xpEarnedToast: "You earned {xp} XP!",
        successTitle: "Success",
        sessionCompletedDesc: "Study session completed!",
        sessionCompletedTitle: "Session Completed!",
        totalXpDesc: "Total XP earned: {xp}",
        saveProgressError: "Failed to save your progress. Please try again.",
        submitRatingError: "Failed to save progress. Please try again.",
      },
    },
    userAccountNav: {
      level: "Level {level}",
