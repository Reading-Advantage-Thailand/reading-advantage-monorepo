export default {
  pages: {
    ...
    settingsUserProfile: {
      heading: "个人信息",
      description: "关于您的个人资料的信息",
      backLink: "← 返回阅读页面",
      email: "邮箱",
      googleClassroom: "Google Classroom 链接",
      level: "Reading Advantage 等级",
    ...
    systemLicense: {
      heading: "系统",
      headerText: "为学校创建新许可证",
      cardTitle: "为您的学校创建新许可证",
      cardDescription:
        "许可证是访问平台的密钥。您可以为学校创建新许可证。您目前共有 {count} 个许可证。",
      columns: {
        ...
        deleteTitle: "删除许可证？",
        deleteDescription:
          "这将永久删除 {schoolName} 的许可证。此操作无法撤销。",
        deleting: "正在删除...",
        confirmDelete: "删除",
      },
      form: {
        schoolName: "学校名称",
        schoolNamePlaceholder: "名称",
        schoolNameDescription: "学校的名称",
        schoolNameMin: "学校名称至少需要 5 个字符。",
        schoolNameMax: "学校名称最多 60 个字符。",
        adminId: "管理员 ID",
        adminIdPlaceholder: "ID",
        adminIdDescription:
          "将被分配管理学校的管理员 ID。负责管理员角色。",
        total: "总数",
        totalPlaceholder: "许可证总数",
        totalDescription: "要创建的许可证总数。",
        subscriptionLevel: "订阅级别",
        subscriptionPlaceholder: "选择订阅级别",
        subscriptionDescription: "许可证的订阅级别。",
        basic: "基础版",
        premium: "高级版",
        enterprise: "企业版",
        expirationDate: "到期日期",
        expirationPlaceholder: "选择有效期",
        expirationDescription: "许可证的有效期。",
        days180: "180 天",
        days360: "360 天",
        createLicenses: "创建许可证",
        createdTitle: "已创建许可证。",
        createdDescription: "已为 {school} 创建 {total} 个 {level} 许可证。",
        errorTitle: "发生错误。",
        errorDescription: "创建许可证失败",
      },
    },
    signInForm: {
      signIn: "登录",
  ...
  components: {
    ...
    flashcards: {
      dashboard: {
        title: "抽认卡控制台",
        descriptionVocabulary: "管理您的词汇学习卡组",
        descriptionSentence: "管理您的句子学习卡组",
        descriptionAll: "管理您的词汇和句子学习卡组",
        vocabularyTab: "词汇",
        sentencesTab: "句子",
      },
      emptyDeck: {
        readyPrompt: "准备好开始您的学习之旅了吗？",
        badgeDefault: "抽认卡系统",
        stepLabel: "第 {step} 步",
        howItWorksTitle: "工作原理",
        howItWorksDescription: "只需三个简单步骤即可开始您的学习之旅",
        whyTitle: "为什么这种方法有效",
        whyDescription: "基于科学学习原则，实现最佳记忆效果",
        finalTitle: "准备好开始学习了吗？",
        finalDescription: "加入每天提升语言技能的数千名学习者",
        feature1Title: "间隔重复",
        feature1Desc: "经科学验证的方法",
        feature2Title: "个性化",
        feature2Desc: "为您量身定制的内容",
        feature3Title: "跟踪进度",
        feature3Desc: "监控进步情况",
        feature4Title: "多语言",
        feature4Desc: "学习任何语言",
        startReadingNow: "立即开始阅读",
        browseArticles: "浏览文章",
        vocabulary: {
          title: "开启您的词汇学习之旅",
          description:
            "通过阅读文章并保存词汇来创建个性化的抽认卡卡组。用科学验证的间隔重复法掌握新单词。",
          actionText: "开始阅读以学习词汇",
          step1Text: "阅读文章",
          step1Desc: "浏览适合您阅读水平的内容",
          step2Text: "保存单词",
          step2Desc: "点击单词添加到您的卡组",
          step3Text: "学习并掌握",
          step3Desc: "用间隔重复法学习",
        },
        sentence: {
          title: "开始掌握句子",
          description:
            "通过阅读文章并保存有意义的句子来建立句子理解能力。通过互动抽认卡练习理解和翻译技能。",
          actionText: "开始阅读以学习句子",
          step1Text: "阅读文章",
          step1Desc: "发现有趣的学习内容",
          step2Text: "保存句子",
          step2Desc: "选择有意义的句子进行练习",
          step3Text: "练习翻译",
          step3Desc: "掌握句子理解",
        },
        all: {
          title: "开始您的学习冒险",
          description:
            "通过阅读文章并保存词汇或句子来构建个性化的抽认卡卡组。使用科学验证的间隔重复法高效学习并记住更多内容。",
          actionText: "开始阅读文章",
          step1Text: "阅读内容",
          step1Desc: "选择适合您水平的精选文章",
          step2Text: "构建您的卡组",
          step2Desc: "保存重要的单词和句子",
          step3Text: "学习并进步",
          step3Desc: "用间隔重复法掌握",
        },
      },
      deck: {
        needMoreCardsTitle: "需要更多卡片才能开始学习",
        needMoreCardsDesc: "再从文章添加 {count} 张卡片即可解锁学习。",
        allCaughtUpTitle: "🎉 全部完成！",
        allCaughtUpDesc: "所有卡片都是最新的。请稍后再来复习。",
        readyTitle: "可以开始学习了！",
        readyDesc: "{count} 张卡片已准备好复习。",
        learningProgress: "学习进度",
        completeLabel: "完成",
        masteredLabel: "已掌握 {count}",
        toReviewLabel: "待复习 {count}",
        cardStatusTitle: "卡片状态明细",
        newLabel: "新卡片",
        newDesc: "待学习的新卡片",
        learningLabel: "学习中",
        learningDesc: "进行中",
        ...
        languageChangedDesc: "翻译语言已更改为 {language}",
        definitionsNote: "释义将以该语言显示",
        translationsNote: "翻译将以该语言显示",
        loadingCards: "正在加载卡片...",
        startStudying: "开始学习（{count} 张卡片）",
        allCaughtUpButton: "全部完成！🎉",
        readArticlesToAddCards: "阅读文章以添加卡片",
        refreshData: "刷新数据",
        refreshSuccessTitle: "成功",
        refreshSuccessDesc: "数据已刷新！",
        addMoreCards: "添加更多卡片",
        noCardsTitle: "没有可用卡片",
        noCardsDesc: "现在没有需要复习的卡片！⏰",
        errorTitle: "错误",
        loadCardsError: "加载卡片失败",
        defaultDeckName: "抽认卡卡组",
      },
      game: {
        errorTitle: "错误",
        noTranslation: "没有翻译",
        sessionCompleteTitle: "学习阶段完成！",
        xpEarned: "+{xp} XP 已获得！",
        greatJob: "做得好！您已完成抽认卡学习阶段。",
        correctLabel: "正确",
        incorrectLabel: "错误",
        timeLabel: "时间",
        completeSession: "完成阶段",
        backToDashboard: "返回控制台",
        noCardsTitle: "没有可用卡片",
        noCardsDesc: "当前没有可学习的卡片。",
        ...
        goodLabel: "良好",
        easyLabel: "简单",
        wordQuestion: "这个单词是什么意思？",
        sentenceQuestion: "这个句子是什么意思？",
        showAnswer: "显示答案",
        skipLabel: "跳过",
        accuracyLabel: "准确率：{percent}%",
        congratulationsTitle: "🎉 恭喜！",
        xpEarnedToast: "您获得了 {xp} XP！",
        successTitle: "成功",
        sessionCompletedDesc: "学习阶段已完成！",
        sessionCompletedTitle: "阶段已完成！",
        totalXpDesc: "获得的总 XP：{xp}",
        saveProgressError: "保存进度失败。请重试。",
        submitRatingError: "保存进度失败。请重试。",
      },
    },
    userAccountNav: {
      level: "等级 {level}",
