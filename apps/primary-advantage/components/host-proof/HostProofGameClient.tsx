...
/**
 * Resolves the responsive profile through the QC session when available so that
 * mechanic state is preserved across reflow. Falls back to a width heuristic
