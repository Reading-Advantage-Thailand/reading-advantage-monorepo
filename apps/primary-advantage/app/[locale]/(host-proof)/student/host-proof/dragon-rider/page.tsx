...
export default async function DragonRiderHostProofPage() { if (!isDragonRiderHostProofEnabled()) notFound(); const user = await getCurrentUser(); if (!user) redirect("/auth/signin"); if (!user.schoolId) notFound(); return <DragonRiderHostProofClient />; }
