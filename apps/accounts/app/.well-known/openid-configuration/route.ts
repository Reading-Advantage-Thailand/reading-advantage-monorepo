...
export async function GET(): Promise<NextResponse> {
  return companyIdentityRouteHandlers.discovery(
    async () => {
...
/** Handles the factual HEAD method without executing the GET side effect. */
export const HEAD = (): NextResponse =>
  companyIdentityRouteHandlers.discoveryHead(accountsHeadResponse);

/** Handles framework preflight explicitly under its reviewed route binding. */
export const OPTIONS = (): NextResponse =>
  companyIdentityRouteHandlers.discoveryOptions(() =>
