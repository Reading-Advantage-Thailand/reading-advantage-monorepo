...
- Name: apk-unit-production.spec.ts >> published APK unit >> persists We Do support and exposes the recoverable verified-report flow
- Location: e2e/apk-unit-production.spec.ts:31:3
...
Call log:
  - navigating to "http://localhost:3200/en/apk-unit/2", waiting until "load"
