...
/**
 * Renders the module page with Thai translations and a resolved route parameter.
 * @returns The rendered module page utilities.
 */
async function renderThaiModule() {
  await act(async () => {
    render(
