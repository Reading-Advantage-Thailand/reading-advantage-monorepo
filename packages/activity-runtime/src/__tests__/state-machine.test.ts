...
describe("framework-neutral activity state machine", () => {
  ...
  it("normalizes playback, checkpoint, tutorial, support, and completion transitions", () => {
    const events = [
      ...
      { ...metadata, eventId: "3", kind: "checkpoint_answered", occurredAt: "2026-07-10T00:00:11Z", checkpointId: "checkpoint.stage", answer: "stage" },
    ...
    expect(state.checkpointAttempts["checkpoint.stage"]).toEqual({ attemptNumber: 1, answer: "stage" });
