...
export const SHADOW_GATE_DUNGEON_MAP: ShadowGateDungeonMap = Object.freeze({
  ...
  paths: Object.freeze([
    ...
    Object.freeze({ id: "northwest-spur", width: 32, points: Object.freeze([point(480, 150), point(300, 150), point(220, 150)]) }),
    Object.freeze({ id: "northeast-spur", width: 32, points: Object.freeze([point(480, 150), point(660, 150), point(740, 150)]) }),
    Object.freeze({ id: "southwest-spur", width: 32, points: Object.freeze([point(480, 390), point(310, 390), point(220, 390)]) }),
  ...
  decor: Object.freeze([
    ...
    feature("ruin-nw", "ruins", "prop:ruins", 250, 90, 48, 48, 13),
    feature("ruin-ne", "ruins", "prop:ruins", 710, 90, 48, 48, 13),
    feature("ruin-sw", "ruins", "prop:ruins", 250, 450, 48, 48, 13),
    feature("ruin-se", "ruins", "prop:ruins", 710, 450, 48, 48, 13),
    feature("lantern-north", "lantern", "prop:lantern", 480, 100, 28, 28, 16),
    feature("lantern-south", "lantern", "prop:lantern", 480, 420, 28, 28, 16),
  ]),
