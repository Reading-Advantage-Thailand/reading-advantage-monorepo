...
describe("legacy traversal Phase 3 Griffin Rider's Escape mechanics", () => {
  it("requires the accepted wave-to-gate traversal loop and deterministic input contract", async () => {
