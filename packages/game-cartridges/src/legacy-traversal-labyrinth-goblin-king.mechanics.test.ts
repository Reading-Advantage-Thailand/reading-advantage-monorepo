...
describe("legacy traversal Phase 3 Labyrinth of the Goblin King mechanics", () => {
  it("requires the accepted maze-to-hazard traversal loop and deterministic input contract", async () => {
