...
export const sentinelProbes: Record<string, SentinelProbe> = {
  ...
  "0052_durable_jobs": {
    tag: "0052_durable_jobs",
    kind: "all",
    target: "durable_job_security",
    allOf: [
      {
        tag: "0052_durable_jobs",
        kind: "table",
      ...
      },
      {
        tag: "0052_durable_jobs",
        kind: "table",
        target: "durable_job_audit_events",
      },
      {
        tag: "0052_durable_jobs",
        kind: "table",
        target: "review_job_adoption_audit_events",
      },
      {
        tag: "0052_durable_jobs",
        kind: "table",
        target: "review_job_durable_bindings",
      },
      {
        tag: "0052_durable_jobs",
        kind: "table",
        target: "review_job_durable_adoption",
      },
      {
        tag: "0052_durable_jobs",
        kind: "table",
        target: "review_job_migration_issues",
      },
      {
        tag: "0052_durable_jobs",
        kind: "trigger",
        target: "durable_job_audit_events_reject_update_delete",
        table: "durable_job_audit_events",
        triggerFunction: "durable_job_reject_audit_mutation",
        triggerTiming: "BEFORE",
        triggerLevel: "ROW",
        triggerEvents: ["UPDATE", "DELETE"],
        triggerFunctionBodySha256:
          "4a0c45e7b67a8518918484ec453f81f6b55e84c3ca95933a711d846cd11e96ae",
        triggerFunctionConfig: ["search_path=pg_catalog"],
        triggerFunctionLanguage: "plpgsql",
        triggerFunctionSecurityDefiner: true,
      },
      {
        tag: "0052_durable_jobs",
        kind: "trigger",
        target: "durable_job_audit_events_reject_truncate",
        table: "durable_job_audit_events",
        triggerFunction: "durable_job_reject_audit_mutation",
        triggerTiming: "BEFORE",
        triggerLevel: "STATEMENT",
        triggerEvents: ["TRUNCATE"],
        triggerFunctionBodySha256:
          "4a0c45e7b67a8518918484ec453f81f6b55e84c3ca95933a711d846cd11e96ae",
        triggerFunctionConfig: ["search_path=pg_catalog"],
        triggerFunctionLanguage: "plpgsql",
      ...
      },
      {
        tag: "0052_durable_jobs",
        kind: "trigger",
        target: "review_job_adoption_audit_events_reject_update_delete",
        table: "review_job_adoption_audit_events",
        triggerFunction: "durable_job_reject_audit_mutation",
        triggerTiming: "BEFORE",
        triggerLevel: "ROW",
        triggerEvents: ["UPDATE", "DELETE"],
      ...
      },
      {
        tag: "0052_durable_jobs",
        kind: "trigger",
        target: "review_job_adoption_audit_events_reject_truncate",
        table: "review_job_adoption_audit_events",
        triggerFunction: "durable_job_reject_audit_mutation",
        triggerTiming: "BEFORE",
        triggerLevel: "STATEMENT",
