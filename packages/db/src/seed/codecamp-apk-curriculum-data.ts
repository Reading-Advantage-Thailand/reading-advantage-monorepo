    ...
    modules: [{
      ...
      lessons: [
        ...
        },
        {
          ...
          exercises: [{ title: "Implement, commit, and push the cartridge manifest", instructions: "Add the full APK manifest without moving persistence into the cartridge. Commit and push it, then run the tutorial checker and report the server-verified result.", starterCode: "export const cartridgeManifest = {\n  // TODO: complete the manifest\n};", expectedOutput: "Both manifest.shape and git.clean checks pass.", hintsJson: ["Inspect the host/cartridge boundary diagram.", "The host owns persistence; the cartridge declares capabilities."], order: 1 }],
        },
        {
