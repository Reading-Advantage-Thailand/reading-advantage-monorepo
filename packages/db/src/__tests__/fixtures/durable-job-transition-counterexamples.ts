...
export const durableJobInvalidRowFixtures: readonly DurableJobInvalidRowFixture[] = [
  {
    id: "job-name-under-bound",
    finding: "T5-H2",
    state: "pending",
    overrides: { job_name: "ab" },
    expectedConstraint: "durable_jobs_job_name_check",
    rationale: "Job names require at least three characters.",
  },
  {
    id: "job-name-over-bound",
    finding: "T5-H2",
    state: "pending",
    overrides: { job_name: `a.${"a".repeat(159)}` },
    expectedConstraint: "durable_jobs_job_name_check",
    rationale: "Job names allow at most 160 characters.",
  },
  {
    id: "job-name-invalid-format",
    finding: "T5-H2",
    state: "pending",
    overrides: { job_name: "Codecamp.review-pr" },
    expectedConstraint: "durable_jobs_job_name_check",
    rationale: "Job names use the approved lowercase namespace format.",
  },
  {
    id: "queue-name-under-bound",
    finding: "T5-H2",
    state: "pending",
    overrides: { queue_name: "" },
    expectedConstraint: "durable_jobs_queue_name_check",
    rationale: "Queue names require at least one character.",
  },
  {
    id: "queue-name-over-bound",
    finding: "T5-H2",
    state: "pending",
    overrides: { queue_name: `a${".a".repeat(50)}` },
    expectedConstraint: "durable_jobs_queue_name_check",
    rationale: "Queue names allow at most 100 characters.",
  },
  {
    id: "queue-name-invalid-format",
    finding: "T5-H2",
    state: "pending",
    overrides: { queue_name: "review main" },
    expectedConstraint: "durable_jobs_queue_name_check",
    rationale: "Queue names use the approved portable format.",
  },
  {
    id: "idempotency-key-under-bound",
    finding: "T5-H2",
    state: "pending",
    overrides: { idempotency_key: "" },
    expectedConstraint: "durable_jobs_idempotency_key_check",
    rationale: "Idempotency keys require at least one character.",
  },
  {
    id: "idempotency-key-over-bound",
    finding: "T5-H2",
    state: "pending",
    overrides: { idempotency_key: "k".repeat(501) },
    expectedConstraint: "durable_jobs_idempotency_key_check",
    rationale: "Idempotency keys allow at most 500 characters.",
  },
  {
    id: "worker-id-under-bound",
    finding: "T5-H2",
    state: "running",
    overrides: { lease_owner: "" },
    expectedConstraint: "durable_jobs_worker_id_check",
    rationale: "Lease owners require at least one character.",
  },
  {
    id: "worker-id-over-bound",
    finding: "T5-H2",
    state: "running",
    overrides: { lease_owner: "w".repeat(201) },
    expectedConstraint: "durable_jobs_worker_id_check",
    rationale: "Lease owners allow at most 200 characters.",
  },
  {
    id: "safe-error-code-invalid-format",
    finding: "T5-H2",
    state: "dead",
    overrides: { last_error_code: "retryable" },
    expectedConstraint: "durable_jobs_safe_error_check",
    rationale: "Safe error codes use the approved uppercase format.",
  },
  {
    id: "safe-error-summary-under-bound",
    finding: "T5-H2",
    state: "dead",
    overrides: { last_error_summary: "" },
    expectedConstraint: "durable_jobs_safe_error_check",
    rationale: "Safe error summaries require at least one character.",
  },
  {
    id: "safe-error-summary-over-bound",
    finding: "T5-H2",
    state: "dead",
    overrides: { last_error_summary: "s".repeat(1_001) },
    expectedConstraint: "durable_jobs_safe_error_check",
    rationale: "Safe error summaries allow at most 1000 characters.",
  },
  {
    id: "payload-fingerprint-invalid-format",
    finding: "T5-H2",
    state: "pending",
    overrides: { payload_fingerprint: "G".repeat(64) },
    expectedConstraint: "durable_jobs_hash_format_check",
    rationale: "Payload fingerprints use lower hexadecimal SHA-256 digests.",
  },
  {
    id: "payload-fingerprint-under-bound",
    finding: "T5-H2",
    state: "pending",
    overrides: { payload_fingerprint: "a".repeat(63) },
    expectedConstraint: "durable_jobs_hash_format_check",
    rationale: "Payload fingerprints require 64 hexadecimal characters.",
  },
  {
    id: "lease-token-hash-invalid-format",
    finding: "T5-H2",
    state: "running",
    overrides: { lease_token_hash: "G".repeat(64) },
    expectedConstraint: "durable_jobs_hash_format_check",
    rationale: "Lease digests use lower hexadecimal SHA-256 values.",
  },
  {
    id: "rerun-payload-fingerprint-invalid-format",
    finding: "T5-H2",
    state: "running",
    overrides: { rerun_payload_fingerprint: "G".repeat(64) },
    expectedConstraint: "durable_jobs_hash_format_check",
    rationale: "Rerun payload fingerprints use lower hexadecimal SHA-256 digests.",
  },
  {
