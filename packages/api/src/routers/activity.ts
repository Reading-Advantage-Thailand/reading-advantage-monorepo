 ...
 */
export function createActivityRouter(resolveHandlers: (context: Context) => ActivityTransportHandlers & { getTeacherSummary(schoolId: string, learnerId: string, sessionId: string): Promise<z.infer<typeof activitySessionSummarySchema> | null> }) {
  return router({
