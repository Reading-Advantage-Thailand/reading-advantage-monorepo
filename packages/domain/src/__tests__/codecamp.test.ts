...
describe("getUserDashboard", () => {
  it("returns aggregated dashboard data with phase grouping", async () => {
    ...
    expect(result.phases.A.portfolioProjectUrl).toBe("https://github.com/Reading-Advantage-Thailand/codecamp-portfolio-website");
    expect(result.phases.B.title).toBe("Frameworks");
    expect(result.phases.B.portfolioProject).toBe("Learning Dashboard");
    expect(result.phases.B.portfolioProjectUrl).toBe("https://github.com/Reading-Advantage-Thailand/codecamp-learning-dashboard");
  });
